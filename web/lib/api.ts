...
export type DiagramNode = { id: string; key: string; label: string; kind: NodeKind; status: NodeStatus; childDiagramKey: string | null; effortId: string | null; effortTitle: string | null; assertionId: string | null; assertionHumanId: string | null };
